...
class AWSSignedCloudfrontDownload_Options
{
  ...
  function aws_signed_cloudfront_download_settings_init() : void {
    ...
    add_settings_field(
      'aws_signed_cloudfront_download_domain_list',
      __('Cloudfront Download Domain List', 'wordpress'),
      array($this, 'aws_signed_cloudfront_download_domain_list_render'),
      'aws_signed_cloudfront_download_pluginPage',
      'aws_signed_cloudfront_download_pluginPage_section'
    );
  ...
  function aws_signed_cloudfront_download_domain_list_render() : void {
    $options = get_option('aws_signed_cloudfront_download_settings');
    echo "<input type='text' size='80' name='aws_signed_cloudfront_download_settings[aws_signed_cloudfront_download_domain_list]' value='{$options['aws_signed_cloudfront_download_domain_list']}' />";
  }
  ...
  function aws_signed_cloudfront_download_options_page() : void {
    ...
    <p>Ensure that you populate the domain list with any top level domains you want to restrict access to.  Downloads will only be processed for these domains.</p>
...
START;
  ...
  function validate_input($input) {
    ...
    $input['aws_signed_cloudfront_download_domain_list'] = trim($input['aws_signed_cloudfront_download_domain_list']);
